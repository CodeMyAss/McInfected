...
import com.sniperzciinema.mcinfected.Command.SubCommands.CreateArenaCommand;
import com.sniperzciinema.mcinfected.Command.SubCommands.CreateLobbyCommand;
import com.sniperzciinema.mcinfected.Command.SubCommands.DeleteArenaCommand;
...
import com.sniperzciinema.mcinfected.Command.SubCommands.SetupCommand;
...
public class CHandler implements TabCompleter, CommandExecutor {
	...
	public CHandler()
	{
		...
		registerSubCommand(new CreateLobbyCommand());
		registerSubCommand(new DeleteArenaCommand());
