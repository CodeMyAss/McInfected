...
public class FileManager {
	...
	private YamlConfiguration	lobbysConfig, messagesConfig, shopsConfig, playersConfig, kitsConfig, commandSetsConfig, disguisesConfig;
	private File							lobbysFile, messagesFile, shopsFile, playersFile, kitsFile, commandSetsFile, disguisesFile;
	...
	public void reloadLobbys() {
		...
		InputStream defConfigStream = this.plugin.getResource("Lobbys.yml");
		if (defConfigStream != null)
		{
			@SuppressWarnings("deprecation")
			YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(defConfigStream);
			if (!this.lobbysFile.exists() || (this.lobbysFile.length() == 0))
				this.lobbysConfig.setDefaults(defConfig);
		}
	}
	...
	public void saveLobbys() {
		...
		{
			Bukkit.getLogger().log(Level.SEVERE, "Could not save config " + this.lobbysFile, ex);
		}
	}
