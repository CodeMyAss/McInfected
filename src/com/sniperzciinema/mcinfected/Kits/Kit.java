...
public class Kit {
	...
	/**
	 * Provide a name and team, and let it get the values from the Kits.yml
	 * 
	 * @param name
	 * @param team
	 */
	public Kit(String name, Team team)
	{
		...
		if (McInfected.getFileManager().getKits().getStringList(team.toString() + "." + getName() + ".Inventory") != null)
			this.inventory = ItemUtil.getItemStacks(McInfected.getFileManager().getKits().getStringList(team.toString() + "." + getName() + ".Inventory"));
		...
		if (McInfected.getFileManager().getKits().getStringList(team.toString() + "." + getName() + ".Potions") != null)
			this.potions = PotionUtil.getPotionEffects(McInfected.getFileManager().getKits().getStringList(team.toString() + "." + getName() + ".Potions"));
	 ...
	 * @param disguise
	 */
	public Kit(String name, Team team, List<String> description, ItemStack icon, ArrayList<ItemStack> inventory, ItemStack helmet,
			ItemStack chestplate, ItemStack leggings, ItemStack boots, ArrayList<PotionEffect> potions, String disguise)
	{
