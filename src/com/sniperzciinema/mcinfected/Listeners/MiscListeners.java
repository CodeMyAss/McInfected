...
public class MiscListeners implements Listener {
	...
	public void onArrowShoot(final ProjectileHitEvent e) {
		...
		if (e.getEntity().getShooter() instanceof Player)
		{
			...
			if (McInfected.getLobbyManager().isPlaying(player) && !McInfected.getLobbyManager().getLobby(player).isStarted())
	...
	public void onPlayerCommandAttempt(PlayerCommandPreprocessEvent e) {
		if (McInfected.getLobbyManager().isPlaying(e.getPlayer()) && !e.getPlayer().isOp())
		{
			String msg = null;
