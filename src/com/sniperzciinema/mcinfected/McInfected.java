...
import com.sniperzciinema.mcinfected.Lobbys.LobbyManager;
...
public class McInfected extends JavaPlugin {
	...
	public static LobbyManager getLobbyManager() {
		return McInfected.lobbyManager;
	}
	...
	public void onDisable() {
		for (Lobby lobby : getLobbyManager().getLobbys())
		{
			for (IPlayer players : lobby.getIPlayers())
				players.leave();
			
			lobby.getTimers().stop();
	...
	public void onEnable() {
		...
		McInfected.lobbyManager = new LobbyManager();
