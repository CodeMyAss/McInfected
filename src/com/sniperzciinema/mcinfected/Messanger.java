...
public class Messanger {
	...
	public enum Messages
	{
		...
		Error__Lobby__No_Valid_Lobbys, Error__Lobby__Already_Exists, Command__CreateLobby;
	};
	 ...
	 * @param string
	 */
	public void broadcast(Lobby lobby, boolean usePrefix, Messages msg, String... variables) {
		String string = getMessage(usePrefix, msg, variables);
		broadcast(lobby, string);
	}
	 ...
	 * @param string
	 */
	public void broadcast(Lobby lobby, String string) {
		for (IPlayer iPlayer : lobby.getIPlayers())
	...
	public String getHeader(String header) {
		return getMessage(false, Messages.Format__Header, "<title>", header);
	}
	
	public String getLine() {
		return getMessage(false, Messages.Format__Line);
	}
	...
	public String getPrefix() {
		return getMessage(false, Messages.Format__Prefix);
	}
}
